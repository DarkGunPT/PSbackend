...
1. **GET /api/v1/bo/count-services-performed:** Retrieves the count of services performed for Back Office.
...
1. **GET /api/v1/bo/services/price:** Retrieves services in a price range.
    * Request body:
      ...
      ```
1. **GET /api/v1/bo/services1/price:** Retrieves services in a price range using a query for Back Office.
    * Query Parameters:
      - `service_type` (string): The type of service you want to filter by (e.g., "PLUMBER").
      - `min` (float): The minimum price for the services you want to retrieve.
      - `max` (float): The maximum price for the services you want to retrieve.

      - **Example Request:**
        ```
        GET /api/v1/bo/services1/price?service_type=PLUMBERg&min=50&max=200
        ```
